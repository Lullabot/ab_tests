...
final class AbVariantDeciderPluginManager extends DefaultPluginManager implements UiPluginManagerInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/AbVariantDecider', $namespaces, $module_handler, AbVariantDeciderInterface::class, AbVariantDecider::class, AbVariantDeciderAttribute::class);
